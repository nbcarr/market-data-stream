...
import requests
from config import API_KEY, POLYGON_FINANCIALS_URL, POLYGON_REST_URL
        ...
        try:
            ...
            if data["status"] == "OK":
                ...
                return {
                    ...
                    "symbol": ticker,
                    "financials": {
                        "earnings_per_share": financials["income_statement"][
                        ...
                        "net_income": financials["income_statement"]["net_income_loss"][
                            "value"
                        ],
                        "operating_income": financials["income_statement"][
